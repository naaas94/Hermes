# Executor packet T1 — A-01 multi-record anchors
...
- **(a)** Committed eval fixtures under `tests/fixtures/eval/` remain the compatibility baseline for T1.
